...
GRML.PortugueseBR = function()
    ...
    GRM_L["GRM Sync Info"] = "GRM by Nexonir Sync Info"
    ...
    GRM_L["Please choose a month between 1 and 999"] = "Por Favor escolha um mês entre 1 e 999"
    GRM_L["Please choose a month between 0 and 999"] = "Por Favor escolha um mês entre 0 e 999"
    ...
    GRM_L["Guild Roster Manager"] = "Guild Roster Manager by Nexonir"
    GRM_L["GRM:"] = "GRM by Nexonir:"                                                                -- Abbreviation for "Guild Roster Manager"
    GRM_L["(Ver:"] = true                                                               -- Ver: is short for Version:
    GRM_L["GRM Updated:"] = "GRM by Nexonir Updated:"
    GRM_L["Configuring Guild Roster Manager for {name} for the first time."] = "Configuring Guild Roster Manager by Nexonir for {name} for the first time."
    ...
    GRM_L["A new version of Guild Roster Manager is Available!"] = "A new version of Guild Roster Manager by Nexonir is Available!"
    ...
    GRM_L["GRM ERROR:"] = "GRM by Nexonir ERROR:"
    ...
    -- tooltips
    GRM_L["|CFFE6CC7FClick|r to open GRM"] = "|CFFE6CC7FClick|r to open GRM by Nexonir"                          -- Please maintain the color coding
    ...
    -- Update 1.137
    GRM_L["GRM: Unable to Create Backup for a Guild With Unknown Creation Date! Log into that guild on any alt to update old database."] = "GRM by Nexonir: Unable to Create Backup for a Guild With Unknown Creation Date! Log into that guild on any alt to update old database."
    ...
    -- update 1.145
    GRM_L["You currently are at {num} non-Battletag friends. To fully take advantage of all of GRM features, please consider clearing some room."] = "You currently are at {num} non-Battletag friends. To fully take advantage of all of GRM by Nexonir features, please consider clearing some room."
    ...
    GRM_L["GRM Debugging Enabled."] = "GRM by Nexonir Debugging Enabled."
    GRM_L["GRM Debugging Disabled."] = "GRM by Nexonir Debugging Disabled."
    ...
    GRM_L["GRM window will open when combat ends."] = "GRM by Nexonir window will open when combat ends."
    ...
    GRM_L["GRM Auto-Detect! {name} has joined the guild and will be set as Main"] = "GRM by Nexonir Auto-Detect! {name} has joined the guild and will be set as Main"            -- Main auto-detect message
    ...
    GRM_L["Hard reset of ALL GRM data, account-wide. Game will reload!"] = "Hard reset of ALL GRM by Nexonir data, account-wide. Game will reload!"
    ...
    GRM_L["Database Still Loading. GRM will open automatically when finished."] = "Database Still Loading. GRM by Nexonir will open automatically when finished."
    ...
    -- R1.32
    GRM_L["GRM has moved the Guild Leader setting restriction codes to the Guild Info tab."] = "GRM by Nexonir has moved the Guild Leader setting restriction codes to the Guild Info tab."
    ...
    GRM_L["One moment, GRM is still being configured."] = "One moment, GRM by Nexonir is still being configured."
    ...
    GRM_L["{num} players were found to have the same name. Please manually select the player's realm"] = "{num} jogadores foram achados com o mesmo nome. Selecione manualmente em qual reino conectado o jogador que você deseja banir está."
    ...
    GRM_L["GRM Date"] = "GRM by Nexonir Date"
    GRM_L["Note Date"] = "Data da Nota"
    GRM_L["Status"] = true
    GRM_L["Refresh"] = "Renovar"
    GRM_L["Clear Selection"] = "Limpar Seleção"
    GRM_L["Fix all mismatched note dates with GRM saved date"] = "Fix all mismatched note dates with GRM by Nexonir saved date"
    GRM_L["Fix selected mismatched note dates with GRM saved date"] = "Fix selected mismatched note dates with GRM by Nexonir saved date"
    GRM_L["Fix all mismatched GRM dates with the note date"] = "Fix all mismatched GRM by Nexonir dates with the note date"
    GRM_L["Fix selected mismatched GRM dates with the note date"] = "Fix selected mismatched GRM by Nexonir dates with the note date"
    ...
    GRM_L["Do you really want to fix note dates using the saved GRM dates?"] = "Do you really want to fix note dates using the saved GRM by Nexonir dates?"
    ...
    GRM_L["Unable to create GRM hotkey macro. You currently are at the cap of {num} macros."] = "Unable to create GRM by Nexonir hotkey macro. You currently are at the cap of {num} macros."
    ...
    -- 1.64
    GRM_L["Chat Window for All GRM Messages:"] = "Chat Window for All GRM by Nexonir Messages:"
    ...
    GRM_L["Player rank change detected, re-checking permissions and rebuilding GRM Macro Tool."] = "Player rank change detected, re-checking permissions and rebuilding GRM by Nexonir Macro Tool."
    ...
    GRM_L["Rules"] = "Regras"
    GRM_L["Please choose a day between 1 and 999"] = "Por Favor selecione um dia entre 1 e 999"
    GRM_L["Please choose a day between 0 and 999"] = "Por Favor selecione um dia entre 0 e 999"
    ...
    -- 1.70
    GRM_L["GRM has errored due to a previous incompatible build with Classic that was enabled. Click YES to reload UI and fix the issue"] = "GRM by Nexonir has errored due to a previous incompatible build with Classic that was enabled. Click YES to reload UI and fix the issue"
    ...
    GRM_L["Do you really want to wipe all GRM data and settings account-wide?"] = "Do you really want to wipe all GRM by Nexonir data and settings account-wide?"
    ...
    -- R1.88
    -- Group Info Module
    GRM_L["GRM Info"] = "GRM by Nexonir Info"
    GRM_L["GRM Group Info"] = "GRM by Nexonir Group Info"
    ...
    GRM_L["Module"] = true
    GRM_L["GRM Optional Modules"] = "GRM by Nexonir Optional Modules"
    GRM_L["Enable Module"] = true
    GRM_L["Show Interactable Distance Indicator"] = true
    GRM_L["No GRM Modules Currently Installed"] = "No GRM by Nexonir Modules Currently Installed"
    ...
    -- R1.89
    GRM_L["GRM API Error:"] = "GRM by Nexonir API Error:"
    ...
    GRM_L["This only affects GRM tooltips"] = "This only affects GRM by Nexonir tooltips"
    ...
    GRM_L["GRM Audit Report:"] = "GRM by Nexonir Audit Report:"                                                               -- Appears after the player's first sync that game secssion.
    ...
    -- R1.90
    GRM_L["GRM WARNING!!! FAILURE TO LOAD THIS KEY: {name}\nPLEASE REPORT TO ADDON DEV! THANK YOU!"] = "GRM by Nexonir WARNING!!! FAILURE TO LOAD THIS KEY: {name}\nPLEASE REPORT TO ADDON DEV! THANK YOU!"
    ...
    GRM_L["Open any GRM window: {name}, {name2}, {custom1}, etc."] = "Open any GRM by Nexonir window: {name}, {name2}, {custom1}, etc."
    ...
    GRM_L["Only Guild Members with GRM installed will see."] = "Only Guild Members with GRM by Nexonir installed will see."
    ...
    GRM_L["Be Informed When GRM is out of date."] = "Be Informed When GRM by Nexonir is out of date."
    ...
    GRM_L["GRM Custom Guild Roster"] = "GRM by Nexonir Custom Guild Roster"
    GRM_L["Unable to Promote players at this rank"] = true
    ...
    GRM_L["Reserved for GRM Macro Tool Usage. Please do not delete."] = "Reserved for GRM by Nexonir Macro Tool Usage. Please do not delete."
    ...
    -- R1.988
    GRM_L["In-combat. Hiding all GRM windows"] = "In-combat. Hiding all GRM by Nexonir windows"
    GRM_L["Auto-Hide all GRM windows when entering combat."] = "Auto-Hide all GRM by Nexonir windows when entering combat."
    ...
    GRM_L["Join Dates"] = "Datas de Entrada"
    GRM_L["Promo Dates"] = "Datas de Promoção"
    GRM_L["Alts/Mains"] = "Alts/Tags de Main"
    GRM_L["Custom Notes"] = "Notas Customizadas"
    GRM_L["Birthdays"] = "Aniversários"
    GRM_L["Main Tags"] = "Tags de Main"
    ...
    GRM_L["Would you like to recreate this chat window for messages unique to the GRM addon?"] = "Would you like to recreate this chat window for messages unique to the GRM by Nexonir addon?"
    GRM_L["\"{name}\" Custom Chat Window for GRM appears to be missing."] = true
    GRM_L["The following Custom Chat Windows for GRM appear to be missing:"] = "The following Custom Chat Windows for GRM by Nexonir appear to be missing:"
    GRM_L["Would you like to recreate these chat windows for messages unique to the GRM addon?"] = "Would you like to recreate these chat windows for messages unique to the GRM by Nexonir addon?"
    ...
    GRM_L["The missing GRM channel has been recreated."] = "The missing GRM by Nexonir channel has been recreated."
    GRM_L["The {num} missing GRM channels have been recreated"] = "The {num} missing GRM by Nexonir channels have been recreated"
    GRM_L["GRM will now only send messages to the following channels:"] = "GRM by Nexonir will now only send messages to the following channels:"
    ...
    GRM_L["GRM will append the message to existing note if room."] = "GRM by Nexonir will append the message to existing note if room."
    ...
    -- 1.9931
    GRM_L["Warning!"] = true
    GRM_L["Your guild Log has {num} entries. Warcraft addons are limited in how much data can be stored. GRM provides this warning as a cushion to help ensure this is never broken as it would result in a catastrophic overflow error that will potentially destroy the GRM save file."] = "Your guild Log has {num} entries. Warcraft addons are limited in how much data can be stored. GRM by Nexonir provides this warning as a cushion to help ensure this is never broken as it would result in a catastrophic overflow error that will potentially destroy the GRM by Nexonir save file."
    ...
    GRM_L["You are at risk for GRM data loss. It is CRITICAL this is handled imediately. Click OK to acknowledge. You will not be warned again."] = "You are at risk for GRM by Nexonir data loss. It is CRITICAL this is handled imediately. Click OK to acknowledge. You will not be warned again."
    GRM_L["You are nearing max GRM storage limit. It is CRITICAL this is handled soon. Click OK to acknowledge."] = "You are nearing max GRM by Nexonir storage limit. It is CRITICAL this is handled soon. Click OK to acknowledge."
    ...
    GRM_L["Given the unusually long time of {num} seconds and sync is still not availble, GRM may not be loading properly. If you are experiencing any Lua errors, please report then to the official GRM Discord channel."] = "Given the unusually long time of {num} seconds and sync is still not availble, GRM by Nexonir may not be loading properly. If you are experiencing any Lua errors, please report then to the official GRM by Nexonir Discord channel."
    ...
    GRM_L["The web app can extract your GRM logs to Text, CSV, or JSON"] = "The web app can extract your GRM by Nexonir logs to Text, CSV, or JSON"
    ...
    -- 1.99346
    GRM_L["View Official GRM Website"] = "View Official GRM by Nexonir Website"
    GRM_L["Want to learn more about GRM, check out the FAQ, changelog, and receive general tips and tricks? Check out the website!"] = "Want to learn more about GRM by Nexonir, check out the FAQ, changelog, and receive general tips and tricks? Check out the website!"
    GRM_L["Check out the new GRM website"] = "Check out the new GRM by Nexonir website"
    ...
    -- 1.99374
    GRM_L["Addons Restricted while engaged in PVP. GRM initialization will continue when the {name} ends."] = "Addons Restricted while engaged in PVP. GRM by Nexonir initialization will continue when the {name} ends."
    GRM_L["Addons Restricted while engaged in a Boss Fight. GRM initialization will continue when the combat ends"] = "Addons Restricted while engaged in a Boss Fight. GRM by Nexonir initialization will continue when the combat ends"
    GRM_L["Addons are no longer restricted. Continuing GRM initialization now."] = "Addons are no longer restricted. Continuing GRM by Nexonir initialization now."
