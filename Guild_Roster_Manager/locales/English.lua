...
GRML.English = function()
    ...
    GRM_L["Please choose a month between 1 and 999"] = true
    GRM_L["Please choose a month between 0 and 999"] = true
    ...
    GRM_L["Prof"] = true        -- /grm prof SLASH COMMAND -- Make your own slash comm.0and
