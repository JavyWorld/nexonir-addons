...
-- TIME AND DATES
    ...
    GRM_L["GRM Auto-Detect! {name} has joined the guild and will be set as Main"] = "GRM by Nexonir Auto-Detect! {name} has joined the guild and will be set as Main"
    ...
    GRM_L["1 player has a join date listed in the incorrect note. The default location is full"] = "1 Spieler hat ein Beitrittsdatum in der falschen Notiz. Der Standardort ist voll."
    GRM_L["{num} players have join dates listed in the incorrect note. The default location is full"] = "{num} Spieler haben Beitrittsdaten in der falschen Notiz. Der Standardort ist voll."
    ...
    GRM_L["GRM Audit Report:"] = "GRM by Nexonir Audit Report:"
