...
GRM_UI.BuildHotKeyEditWindow = function()
    ...
    GRM_UI.CreateString ( "GRM_HotKeyText" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolEditHotKeyFrame , "GameFontNormal" , "" , 13 , { "TOP" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolEditHotKeyFrame.GRM_EditHotKeyTitle , "BOTTOM" , 0 , -15 } , 150 , { 0.0 , 0.8 , 1.0 } , "CENTER" , true );
    ...
    GRM_UI.CreateButton ( "GRM_HotKeyClearButton" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolEditHotKeyFrame , "UIPanelButtonTemplate" , GRM.L ( "Clear" ) , 85 , 25 , { "LEFT" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolEditHotKeyFrame , "LEFT" , 20 , 4 } , GRM_Macro.ClearHotKey , "GameFontNormal" , 12 , "CENTER"  );
    ...
    GRM_UI.CreateButton ( "GRM_HotKeyConfirmButton" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolEditHotKeyFrame , "UIPanelButtonTemplate" , GRM.L ( "Confirm" ) , 85 , 25 , { "RIGHT" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolEditHotKeyFrame , "RIGHT" , -20 , 4 } , GRM_Macro.ConfirmHotKey , "GameFontNormal" , 12 , "CENTER" );
...
GRM_UI.GRM_ToolCoreFrame.GRM_MacroToolDisableLogSpamCheckbutton = CreateFrame ( "CheckButton" , "GRM_MacroToolDisableLogSpamCheckbutton" , GRM_UI.GRM_ToolCoreFrame , "InterfaceOptionsCheckButtonTemplate" );
...
-- Online Cnly Control
GRM_UI.GRM_ToolCoreFrame.GRM_MacroToolShowOnlineOnlyCheckButton = CreateFrame ( "CheckButton" , "GRM_MacroToolShowOnlineOnlyCheckButton" , GRM_UI.GRM_ToolCoreFrame , "InterfaceOptionsCheckButtonTemplate" );
...
GRM_UI.GRM_ToolCoreFrame.GRM_ToolIgnoreListFrame.GRM_ToolCoreIgnoreCheckButton = CreateFrame ( "CheckButton" , "GRM_ToolCoreIgnoreCheckButton" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolIgnoreListFrame , "InterfaceOptionsCheckButtonTemplate" );
...
-- Tabs
GRM_UI.GRM_ToolCoreFrame.GRM_KickTab = CreateFrame ( "Button" , "GRM_KickTab" , GRM_UI.GRM_ToolCoreFrame , "MinimalTabTemplate" );
...
GRM_UI.GRM_ToolCoreFrame.GRM_PromoTab = CreateFrame ( "Button" , "GRM_PromoTab" , GRM_UI.GRM_ToolCoreFrame , "MinimalTabTemplate" );
...
GRM_UI.GRM_ToolCoreFrame.GRM_DemoteTab = CreateFrame ( "Button" , "GRM_DemoteTab" , GRM_UI.GRM_ToolCoreFrame , "MinimalTabTemplate" );
...
GRM_UI.GRM_ToolCoreFrame.GRM_SpecialTab = CreateFrame ( "Button" , "GRM_SpecialTab" , GRM_UI.GRM_ToolCoreFrame , "MinimalTabTemplate" );
...
-- Class Custom Rules
GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_ToolCustomRulesClassCheckBox = CreateFrame ( "CheckButton" , "GRM_ToolCustomRulesClassCheckBox" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame , "InterfaceOptionsCheckButtonTemplate" );
...
-- Custom Rule Filters
GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_ToolRecommendKickCheckButton = CreateFrame ( "CheckButton" , "GRM_ToolRecommendKickCheckButton" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame , "InterfaceOptionsCheckButtonTemplate" );
...
-- Alts control filter
GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_ToolAltsOfflineTimed = CreateFrame ( "CheckButton" , "GRM_ToolAltsOfflineTimed" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame , "InterfaceOptionsCheckButtonTemplate" );
...
GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_KickEvenIfActiveButton = CreateFrame ( "CheckButton" , "GRM_KickEvenIfActiveButton" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame , "InterfaceOptionsCheckButtonTemplate" );
...
GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_ToolCompareStringCheckButton = CreateFrame ( "CheckButton" , "GRM_ToolCompareStringCheckButton" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame , "InterfaceOptionsCheckButtonTemplate" );
...
GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_ToolEmptyCheckButton = CreateFrame ( "CheckButton" , "GRM_ToolEmptyCheckButton" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame , "InterfaceOptionsCheckButtonTemplate" );
...
GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_ToolPublicNoteCheckButton = CreateFrame ( "CheckButton" , "GRM_ToolPublicNoteCheckButton" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame , "InterfaceOptionsCheckButtonTemplate" );
...
GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_ToolOfficerCheckButton = CreateFrame ( "CheckButton" , "GRM_ToolOfficerCheckButton" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame , "InterfaceOptionsCheckButtonTemplate" );
...
GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_ToolCustomCheckButton = CreateFrame ( "CheckButton" , "GRM_ToolCustomCheckButton" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame , "InterfaceOptionsCheckButtonTemplate" );
...
GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_SafeTextMatchButton = CreateFrame ( "CheckButton" , "GRM_SafeTextMatchButton" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame , "InterfaceOptionsCheckButtonTemplate" );
...
-- MythicPlusRules
GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_MythicRatingRuleCheckButton = CreateFrame ( "CheckButton" , "GRM_MythicRatingRuleCheckButton" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame , "InterfaceOptionsCheckButtonTemplate" );
...
-- Log Custom Message
GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_CustomLogMessageButton = CreateFrame ( "CheckButton" , "GRM_CustomLogMessageButton" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame , "InterfaceOptionsCheckButtonTemplate" );
...
GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdText = GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame:CreateFontString ( nil , "OVERLAY" , "GameFontNormalSmall" );
GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdEditBox = CreateFrame( "EditBox" , "GRM_PromoMessageThresholdEditBox" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame , "InputBoxTemplate" );
GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdEditBox:ClearFocus();
GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdText = GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame:CreateFontString ( nil , "OVERLAY" , "GameFontNormalSmall" );
GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdEditBox = CreateFrame( "EditBox" , "GRM_PromoConnectionThresholdEditBox" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame , "InputBoxTemplate" );
GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdEditBox:ClearFocus();
...
GRM_UI.LoadToolFrames = function ( isManual )
    ...
    if not isManual then
        ...
        GRM_UI.GRM_ToolCoreFrame.GRM_CustomRuleAddButton:SetPoint ( "TOP" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolRulesScrollBorderFrame , "BOTTOM" , 0 , -20 );
        ...
        GRM_UI.GRM_ToolCoreFrame.GRM_ToolResetSettingsButton:SetPoint ( "BOTTOMRIGHT" , GRM_UI.GRM_ToolCoreFrame , "BOTTOMRIGHT" , -30 , 30 );
        ...
        GRM_UI.GRM_ToolCoreFrame.GRM_PromoTab:SetHighlightTexture ( "Interface\\Buttons\\ButtonHilight-Square" );
        ...
        GRM_UI.GRM_ToolCoreFrame.GRM_DemoteTab:SetHighlightTexture ( "Interface\\Buttons\\ButtonHilight-Square" );
        ...
        GRM_UI.GRM_ToolCoreFrame.GRM_SpecialTab:SetHighlightTexture ( "Interface\\Buttons\\ButtonHilight-Square" );
        ...
        GRM_UI.GRM_ToolCoreFrame.GRM_ToolContextMenu.GRM_ContextButton1:SetHighlightTexture ( "Interface\\PaperDollInfoFrame\\UI-Character-Tab-Highlight" );
        ...
        GRM_UI.GRM_ToolCoreFrame.GRM_ToolContextMenu.GRM_ContextButton2:SetHighlightTexture ( "Interface\\PaperDollInfoFrame\\UI-Character-Tab-Highlight" );
        ...
        GRM_UI.GRM_ToolCoreFrame.GRM_ToolContextMenu.GRM_ContextButton3:SetHighlightTexture ( "Interface\\PaperDollInfoFrame\\UI-Character-Tab-Highlight" );
        ...
        GRM_UI.GRM_ToolCoreFrame.GRM_ToolContextMenu.GRM_ToolContextMenuCancelButton:SetHighlightTexture ( "Interface\\PaperDollInfoFrame\\UI-Character-Tab-Highlight" );
    ...
    -- Method:          GRM_R.SetRuleCheckedStatus()
    ...
    if not isManual then
        ...
        GRM_UI.EnableRankActivityFrames = function()
            ...
            GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdText:SetTextColor ( 1 , 0.82 , 0 );
            GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdEditBox:Enable();
            GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdEditBox:SetTextColor ( 1 , 0 , 0 );
            GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdText:SetTextColor ( 1 , 0.82 , 0 );
            GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdEditBox:Enable();
            GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdEditBox:SetTextColor ( 1 , 0 , 0 );
        ...
        GRM_UI.DisableRankActivityFrames = function()
            ...
            GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdText:SetTextColor ( 0.5 , 0.5 , 0.5 );
            GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdEditBox:Disable();
            GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdEditBox:SetTextColor ( 0.5 , 0.5 , 0.5 );
            GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdText:SetTextColor ( 0.5 , 0.5 , 0.5 );
            GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdEditBox:Disable();
            GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdEditBox:SetTextColor ( 0.5 , 0.5 , 0.5 );
        end
        ...
        GRM_UI.ConfigureCustomRulePromoteAndDemoteFrame = function ( isEdit , ruleName , isCopy )
            ...
            if isEdit then
                ...
                if GRM_UI.GRM_ToolCoreFrame.TabPosition == 2 then
                    local minMessages = math.max(0, math.floor(tonumber(GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.rule.minimumMessageCount or GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.rule.minimumActivityScore) or 0));
                    local minConnections = math.max(0, math.floor(tonumber(GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.rule.minimumConnectionCount) or 0));

                    GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.rule.minimumMessageCount = minMessages;
                    GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.rule.minimumActivityScore = minMessages;
                    GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.rule.minimumConnectionCount = minConnections;

                    GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdEditBox.value = minMessages;
                    GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdEditBox:SetText ( tostring(minMessages) );
                    GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdEditBox.value = minConnections;
                    GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdEditBox:SetText ( tostring(minConnections) );
        ...
        GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdText:SetText ( GRM.L ( "Minimum Guild Chat Messages:" ) );
        GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdText:SetText ( GRM.L ( "Minimum Connection Sessions:" ) );

        GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdEditBox:SetSize ( 45 , 22 );
        GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdEditBox:SetMaxLetters ( 6 );
        GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdEditBox:SetNumeric ( true );
        GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdEditBox:SetAutoFocus( false );
        GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdEditBox:SetTextColor ( 1.0 , 0 , 0 , 1.0 );
        GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdEditBox.value = 0;

        GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdEditBox:SetSize ( 45 , 22 );
        GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdEditBox:SetMaxLetters ( 6 );
        GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdEditBox:SetNumeric ( true );
        GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdEditBox:SetAutoFocus( false );
        GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdEditBox:SetTextColor ( 1.0 , 0 , 0 , 1.0 );
        GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdEditBox.value = 0;

        local SetPromotionMetricThreshold = function ( self , ruleField , fallbackValue )
            self:HighlightText ( 0 , 0 );

            local metricValue = math.floor(tonumber(self:GetText()) or fallbackValue);
            if metricValue < 0 or metricValue > 999999 then
                GRM.Report ( GRM.L ( "Please choose a value between 0 and 999999" ) );
                metricValue = fallbackValue;
            end

            GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.rule[ruleField] = metricValue;
            if ruleField == "minimumMessageCount" then
                -- Legacy compatibility with older stored rules.
                GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.rule.minimumActivityScore = metricValue;
                GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdEditBox.value = metricValue;
            else
                GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdEditBox.value = metricValue;
            end

            self:SetText ( tostring(metricValue) );
        end

        GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdEditBox:SetScript ( "OnEscapePressed" , function( self )
            self:SetText ( GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdEditBox.value );
            self:ClearFocus();
        end );

        GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdEditBox:SetScript ( "OnEscapePressed" , function( self )
            self:SetText ( GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdEditBox.value );
            self:ClearFocus();
        end );

        GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdEditBox:SetScript ( "OnEnterPressed" , function( self )
            self:ClearFocus();
        end );

        GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdEditBox:SetScript ( "OnEnterPressed" , function( self )
            self:ClearFocus();
        end );

        GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdEditBox:SetScript ( "OnEditFocusLost" , function( self )
            local fallbackValue = GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdEditBox.value or 0;
            SetPromotionMetricThreshold ( self , "minimumMessageCount" , fallbackValue );
        end );

        GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdEditBox:SetScript ( "OnEditFocusLost" , function( self )
            local fallbackValue = GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdEditBox.value or 0;
            SetPromotionMetricThreshold ( self , "minimumConnectionCount" , fallbackValue );
        end );

        GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdEditBox:SetScript ( "OnEnter" , function( self )
            GRM_UI.SetTooltipScale();
            GameTooltip:SetOwner ( self , "ANCHOR_CURSOR" );
            GameTooltip:AddLine ( GRM.L ( "Minimum guild chat messages tracked while you are online." ) );
            GameTooltip:Show();
        end );

        GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdEditBox:SetScript ( "OnLeave" , function()
            GRM.RestoreTooltip();
        end );

        GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdEditBox:SetScript ( "OnEnter" , function( self )
            GRM_UI.SetTooltipScale();
            GameTooltip:SetOwner ( self , "ANCHOR_CURSOR" );
            GameTooltip:AddLine ( GRM.L ( "Minimum login/connect sessions tracked while you are online." ) );
            GameTooltip:Show();
        end );

        GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdEditBox:SetScript ( "OnLeave" , function()
            GRM.RestoreTooltip();
        end );
        ...
        GRM_UI.ModifyRuleUI = function()
            ...
            GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdText:ClearAllPoints();
            GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdEditBox:ClearAllPoints();
            GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdText:ClearAllPoints();
            GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdEditBox:ClearAllPoints();
            ...
            if GRM_UI.GRM_ToolCoreFrame.TabPosition == 1 or GRM_UI.GRM_ToolCoreFrame.TabPosition == 3 then
                ...
                GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdText:Hide();
                GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdEditBox:Hide();
                GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdText:Hide();
                GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdEditBox:Hide();
            ...
            elseif GRM_UI.GRM_ToolCoreFrame.TabPosition == 2 then
                ...
                GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdText:SetPoint ( "TOPLEFT" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_KickEvenIfActiveButtonText , "BOTTOMLEFT" , 0 , -6 );
                GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdEditBox:SetPoint ( "LEFT" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdText , "RIGHT" , 5 , 0 );
                GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdText:SetPoint ( "TOPLEFT" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdText , "BOTTOMLEFT" , 0 , -6 );
                GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdEditBox:SetPoint ( "LEFT" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdText , "RIGHT" , 5 , 0 );
                ...
                GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_ToolCustomRulesLevelRadialButton1:SetPoint ( "TOPRIGHT" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_KickEvenIfActiveButton , "BOTTOMLEFT" , 0 , 25 );
                GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_ToolAltsOfflineTimed:SetPoint ( "TOPLEFT" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdText , "BOTTOMLEFT" , -5 , -10 );
                GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_ApplyRulesText:SetPoint ( "TOPLEFT" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame , "TOPLEFT" , 38 , -80 );

                if GRM.S().selectedLang == 5 then -- Russian
                    GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame:SetSize ( 450 , 810 );
                else
                    GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame:SetSize ( 450 , 810 );
                end
                ...
                GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_KickEvenIfActiveEditBox:Show();
                GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_KickEvenIfActiveButtonText:Show();
                GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdText:Show();
                GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoMessageThresholdEditBox:Show();
                GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdText:Show();
                GRM_UI.GRM_ToolCoreFrame.GRM_ToolCustomRulesFrame.GRM_PromoConnectionThresholdEditBox:Show();
        ...
        GRM_UI.LocalizationMModifications = function()
            ...
            if GRM.S().selectedLang == 2 or GRM.S().selectedLang == 5 then -- Russian
                ...
                GRM_UI.GRM_ToolCoreFrame.GRM_ToolViewSafeListButton:ClearAllPoints();
                GRM_UI.GRM_ToolCoreFrame.GRM_ToolViewSafeListButton:SetPoint ( "TOP" , GRM_UI.GRM_ToolCoreFrame.GRM_ToolResetSelectedMacroNamesButton , "BOTTOM" , 0 , -70 );
...
GRM.GetToolTipLine = function ( rulePart )
    ...
    for i = 1 , #rulePart do
        ...
        elseif rulePart[i][1] == "Destination" then
            table.insert ( result , " - " .. rulePart[i][2] );
        elseif rulePart[i][1] == "ActivityLevel" then
            local sourceName = rulePart[i][4] or "recent_messages_30d";
            table.insert ( result , " - Activity Score: " .. tostring(rulePart[i][2]) .. " (" .. sourceName .. " >= " .. tostring(rulePart[i][3]) .. ")" );
        elseif rulePart[i][1] == "ConnectionLevel" then
            local sourceName = rulePart[i][4] or "recent_connections_7d";
            table.insert ( result , " - Connection Score: " .. tostring(rulePart[i][2]) .. " (" .. sourceName .. " >= " .. tostring(rulePart[i][3]) .. ")" );
        end
    end
...
GRM.GetOnlySafePlayersWithIgnoredAction = function ()
    ...
    for i = 1 , #GRM_UI.GRM_ToolCoreFrame.Safe do
        ...
        result[i].lastOnlineTime = GRM_UI.GRM_ToolCoreFrame.Safe[i].lastOnlineTime;
    end
    return result;
end
...
GRM_Macro.GetMacroRuleGUID = function ( rule )
    return tostring ( GRMsync.ConvertStringToVal ( rule.name ) + rule.editTime ); -- Just tyake byte value of name + epoch time. Will always be unique
end
...
GRM.BuildNewPromoteOrDemoteRuleTemplate = function ( name , num , tabPosition )
    ...
    if position == 2 then
        ...
        result.minimumMessageCount = 0;    -- Minimum tracked guild-chat messages required for promotion.
        result.minimumActivityScore = 0;   -- Legacy compatibility for older rules and historical feed parsing.
        result.minimumConnectionCount = 0; -- Minimum tracked connection sessions required for promotion.
        result.rankSpecialIsMonths = true;
    ...
    for i = 1 , #GRM_UI.GRM_ToolCoreFrame.RuleEntries do
        ...
        if i <= hybridScrollFrameButtonCount then
            if not GRM_UI.GRM_ToolCoreFrame.GRM_ToolRulesScrollChildFrame.AllButtons[i] then
                ...
                local checkButton = CreateFrame ( "Checkbutton" , "RuleCheckButton" .. i , button , "InterfaceOptionsCheckButtonTemplate" );
...
GRM.UpdateRulesTooltip = function ( ind )
    ...
    if GRM_UI.GRM_ToolCoreFrame.TabPosition == 2 then
        local minMessageCount = math.max(0, math.floor(tonumber(rule.minimumMessageCount or rule.minimumActivityScore) or 0));
        local minConnectionCount = math.max(0, math.floor(tonumber(rule.minimumConnectionCount) or 0));

        if minMessageCount > 0 then
            GameTooltip:AddDoubleLine ( GRM.L ( "Chat Activity:" ) , GRM.L ( "At least {num} guild messages" , nil , nil , minMessageCount ) , 1 , 0.82 , 0 , 1 , 1 , 1 );
        else
            GameTooltip:AddDoubleLine ( GRM.L ( "Chat Activity:" ) , GRM.L ( "Disabled" ) , 1 , 0.82 , 0 , c.D[1] , c.D[2] , c.D[3] );
        end

        if minConnectionCount > 0 then
            GameTooltip:AddDoubleLine ( GRM.L ( "Connection Activity:" ) , GRM.L ( "At least {num} connection sessions" , nil , nil , minConnectionCount ) , 1 , 0.82 , 0 , 1 , 1 , 1 );
        else
            GameTooltip:AddDoubleLine ( GRM.L ( "Connection Activity:" ) , GRM.L ( "Disabled" ) , 1 , 0.82 , 0 , c.D[1] , c.D[2] , c.D[3] );
        end
    end
...
local DemoteFilterMatch = function( player , ruleName , rule , tempRuleCollection )
...
local NormalizeGATActivityName = function( rawName )
    if type(rawName) ~= "string" then
        return nil;
    end

    local name = GRM.Trim(rawName);
    if name == "" then
        return nil;
    end
    ...
    if dashPos then
        local playerName = string.sub(name, 1, dashPos - 1);
        local realmName = string.sub(name, dashPos + 1);
...
local BuildGATActivityLookupKeys = function( playerName )
    local result = {};
    local seen = {};

    local AddLookupKey = function( key )
    ...
    local normalized = NormalizeGATActivityName(playerName);
    AddLookupKey(normalized);

    if normalized then
        local dashPos = string.find(normalized, "-", 1, true);
        if dashPos then
            AddLookupKey(string.sub(normalized, 1, dashPos - 1));
        elseif GRM_G.realmName and GRM_G.realmName ~= "" then
            AddLookupKey(normalized .. "-" .. string.lower(GRM_G.realmName));
        end
    end
...
local MergeActivityMetric = function( metricMap , key , value )
    local sanitizedValue = math.max(0, math.floor(tonumber(value) or 0));
    if metricMap[key] == nil or sanitizedValue > metricMap[key] then
        metricMap[key] = sanitizedValue;
    end
end

local MergeActivityFeedToCache = function( feed )
    if type(feed) ~= "table" or tonumber(feed.schema_version) ~= 1 then
        return;
    end

    if type(feed.message_counter_map) == "table" then
        for fullName, count in pairs(feed.message_counter_map) do
            local normalized = NormalizeGATActivityName(fullName);
            if normalized then
                MergeActivityMetric ( GRM_GATActivityCache.counters , normalized , count );
            end
        end
    end

    if type(feed.connection_counter_map) == "table" then
        for fullName, count in pairs(feed.connection_counter_map) do
            local normalized = NormalizeGATActivityName(fullName);
            if normalized then
                MergeActivityMetric ( GRM_GATActivityCache.connectionCounters , normalized , count );
            end
        end
    end

    if type(feed.members) == "table" then
        for i = 1, #feed.members do
            local member = feed.members[i];
            if type(member) == "table" and type(member.name) == "string" then
                local normalized = NormalizeGATActivityName(member.name);
                if normalized then
                    local cacheMember = GRM_GATActivityCache.members[normalized] or {};

                    if tonumber(member.recent_messages_30d) ~= nil then
                        cacheMember.recent_messages_30d = math.max(tonumber(cacheMember.recent_messages_30d) or 0, math.max(0, math.floor(tonumber(member.recent_messages_30d) or 0)));
                    end

                    if tonumber(member.total_messages) ~= nil then
                        cacheMember.total_messages = math.max(tonumber(cacheMember.total_messages) or 0, math.max(0, math.floor(tonumber(member.total_messages) or 0)));
                    end

                    if tonumber(member.recent_connections_7d) ~= nil then
                        cacheMember.recent_connections_7d = math.max(tonumber(cacheMember.recent_connections_7d) or 0, math.max(0, math.floor(tonumber(member.recent_connections_7d) or 0)));
                    end

                    if tonumber(member.total_connections) ~= nil then
                        cacheMember.total_connections = math.max(tonumber(cacheMember.total_connections) or 0, math.max(0, math.floor(tonumber(member.total_connections) or 0)));
                    end

                    if cacheMember.name == nil then
                        cacheMember.name = member.name;
                    end

                    GRM_GATActivityCache.members[normalized] = cacheMember;
                end
            end
        end
    end
...
local RefreshGATActivityCache = function()
    local externalFeed = GuildRosterManagerGATFeed;
    local localFeed = nil;

    if GRM.GetGuildActivityMetricsFeed then
        localFeed = GRM.GetGuildActivityMetricsFeed();
    end

    if GRM_GATActivityCache.externalFeed == externalFeed and GRM_GATActivityCache.localFeed == localFeed then
        return GRM_GATActivityCache;
    end

    local hasExternalFeed = type(externalFeed) == "table" and tonumber(externalFeed.schema_version) == 1;
    local hasLocalFeed = type(localFeed) == "table" and tonumber(localFeed.schema_version) == 1;
    if not hasExternalFeed and not hasLocalFeed then
        GRM_GATActivityCache.externalFeed = externalFeed;
        GRM_GATActivityCache.localFeed = localFeed;
        GRM_GATActivityCache.counters = {};
        GRM_GATActivityCache.connectionCounters = {};
        GRM_GATActivityCache.members = {};
        return nil;
    end
    ...
    MergeActivityFeedToCache ( externalFeed );
    if localFeed ~= externalFeed then
        MergeActivityFeedToCache ( localFeed );
    end

    return GRM_GATActivityCache;
end

local GetGATActivityForName = function( playerName )
    local cache = RefreshGATActivityCache();
    if not cache then
        return nil, nil, nil, nil, false;
    end

    local lookupKeys = BuildGATActivityLookupKeys(playerName);
    for i = 1, #lookupKeys do
        local key = lookupKeys[i];
        local member = cache.members[key];
        local recentMessages = member and tonumber(member.recent_messages_30d);
        local totalMessages = cache.counters[key];
        local recentConnections = member and tonumber(member.recent_connections_7d);
        local totalConnections = cache.connectionCounters[key];

        if totalMessages == nil and member then
            totalMessages = tonumber(member.total_messages);
        end

        if totalConnections == nil and member then
            totalConnections = tonumber(member.total_connections);
        end

        if recentMessages ~= nil or totalMessages ~= nil or recentConnections ~= nil or totalConnections ~= nil then
            if recentMessages ~= nil then
                recentMessages = math.max(0, math.floor(recentMessages));
            end
            if totalMessages ~= nil then
                totalMessages = math.max(0, math.floor(totalMessages));
            end
            if recentConnections ~= nil then
                recentConnections = math.max(0, math.floor(recentConnections));
            end
            if totalConnections ~= nil then
                totalConnections = math.max(0, math.floor(totalConnections));
            end
            return recentMessages, totalMessages, recentConnections, totalConnections, true;
        end
    end
...
local GetPromotionActivityMetrics = function( playerName, alts, includeAlts )
    local bestRecentMessages = nil;
    local bestTotalMessages = nil;
    local bestRecentConnections = nil;
    local bestTotalConnections = nil;
    local feedAvailable = false;

    local CaptureBest = function( targetName )
        local recentMessages, totalMessages, recentConnections, totalConnections, hasFeed = GetGATActivityForName(targetName);
        if hasFeed then
            feedAvailable = true;
        end

        local messageScore = recentMessages;
        if messageScore == nil then
            messageScore = totalMessages;
        end

        if messageScore ~= nil then
            local bestScore = bestRecentMessages;
            if bestScore == nil then
                bestScore = bestTotalMessages;
            end

            if bestScore == nil or messageScore > bestScore then
                bestRecentMessages = recentMessages;
                bestTotalMessages = totalMessages;
            end
        end

        local connectionScore = recentConnections;
        if connectionScore == nil then
            connectionScore = totalConnections;
        end

        if connectionScore ~= nil then
            local bestConnectionScore = bestRecentConnections;
            if bestConnectionScore == nil then
                bestConnectionScore = bestTotalConnections;
            end

            if bestConnectionScore == nil or connectionScore > bestConnectionScore then
                bestRecentConnections = recentConnections;
                bestTotalConnections = totalConnections;
            end
        end
    end

    CaptureBest(playerName);

    if includeAlts and type(alts) == "table" then
        for i = 1, #alts do
            if alts[i] ~= playerName then
                CaptureBest(alts[i]);
            end
        end
    end

    local messageScore = bestRecentMessages;
    local messageSource = "recent_messages_30d";
    if messageScore == nil then
        messageScore = bestTotalMessages;
        messageSource = "total_messages";
    end

    local connectionScore = bestRecentConnections;
    local connectionSource = "recent_connections_7d";
    if connectionScore == nil then
        connectionScore = bestTotalConnections;
        connectionSource = "total_connections";
    end

    return messageScore, messageSource, connectionScore, connectionSource, feedAvailable;
end

local PromoteFilterMatch = function( player , ruleName , rule , tempRuleCollection )
    local ruleConfirmedCheck = false;
    local alts = GRM.GetAltNamesList ( player );
    ...
    if valid then
        ...
        if rule.regardlessOfActivity then
            ...
            if player.lastOnline < GRM_G.NumberOfHoursTilRecommend[GRM_UI.ruleTypeEnum2[rule.ruleType]][ruleName].inactive or ( rule.allAltsApplyToKick and GRM.IsAnyAltActive ( alts , GRM_G.NumberOfHoursTilRecommend[GRM_UI.ruleTypeEnum2[rule.ruleType]][ruleName].inactive ) ) then
                local minMessageCount = math.max(0, math.floor(tonumber(rule.minimumMessageCount or rule.minimumActivityScore) or 0));
                local minConnectionCount = math.max(0, math.floor(tonumber(rule.minimumConnectionCount) or 0));
                local messageScore, messageSource, connectionScore, connectionSource, hasGATFeed = GetPromotionActivityMetrics(player.name, alts, rule.allAltsApplyToKick);
                local hasRequiredActivity = true;

                -- Legacy compatibility with older rules.
                rule.minimumMessageCount = minMessageCount;
                rule.minimumActivityScore = minMessageCount;
                rule.minimumConnectionCount = minConnectionCount;

                -- If an activity feed exists, enforce configured thresholds.
                if hasGATFeed and minMessageCount > 0 then
                    hasRequiredActivity = (tonumber(messageScore) or 0) >= minMessageCount;
                end

                if hasRequiredActivity and hasGATFeed and minConnectionCount > 0 then
                    hasRequiredActivity = (tonumber(connectionScore) or 0) >= minConnectionCount;
                end

                if hasRequiredActivity then
                    ruleConfirmedCheck = true;
                    ...
                    if hasGATFeed and minMessageCount > 0 then
                        table.insert ( tempRuleCollection , { "ActivityLevel" , (tonumber(messageScore) or 0) , minMessageCount , messageSource } );
                    end

                    if hasGATFeed and minConnectionCount > 0 then
                        table.insert ( tempRuleCollection , { "ConnectionLevel" , (tonumber(connectionScore) or 0) , minConnectionCount , connectionSource } );
                    end
                end
            end
        end
...
GRM.GetKickNamesByFilterRulesChunk = function(allPlayerNamesSorted, startIndex, chunkSize, includeHigherAlt, highest)
    ...
    if GRM.GetRulesCount(1) == 0 or not GRM_G.guildName or GRM_G.guildName == "" then
        return recommendationsForThisChunk, higherAltRuleMatchesCount, ruleDisabledListForThisChunk;
    end

    local function GetOrAddPlayerRecEntry(list, playerName, playerClass)
        ...
        local newEntry = {
            name = playerName,
            class = GRM.GetClassColorRGB(playerClass),
            action = GRM_UI.ruleTypeEnum3[1], -- "Kick"
            macro = "/gremove",
        };
    ...
    for i = startIndex, endIndex do
        local playerName = allPlayerNamesSorted[i];
        local player = GRM.GetPlayer(playerName);
        local processThisPlayer = true; -- Flag to control if we process rules for this player

        if not player or type(player) ~= "table" then
            processThisPlayer = false;
        end

        if processThisPlayer and player.name == GRM_G.addonUser then
            if not (includeHigherAlt and highest and highest[2] and highest[2] ~= player.name) then
                processThisPlayer = false;
            end
        end

        if processThisPlayer then
            local playerRecommendationEntry = nil;

            for ruleName, rule in pairs(GRM.S().kickRules) do
                local processThisRuleForPlayer = true; -- Flag to control if we process this specific rule
                ruleConfirmedCheck = true;
                tempRuleCollection = {};
                local isActionForHigherAltOnly = false;

                local canCurrentCharKick = (GRM_G.playerRankID < player.rankIndex and CanGuildRemove());
                local canHigherAltKick = (includeHigherAlt and highest and highest[1] and GRM_G.playerRankID ~= highest[1] and highest[1] < player.rankIndex);

                if canCurrentCharKick then
                    isActionForHigherAltOnly = false;
                elseif canHigherAltKick then
                    isActionForHigherAltOnly = true;
                else
                    if not rule.isEnabled then
                        ruleDisabledListForThisChunk[player.name] = true;
                    end
                    processThisRuleForPlayer = false; -- Skip this rule for this player
                end

                if processThisRuleForPlayer then
                    -- === Start of existing rule filter logic ===
                    if ruleConfirmedCheck and rule.applyRulesTo > 1 then
                        ...
                        if rule.applyRulesTo == 2 and not GRM.IsMain(player.name) and GRM.PlayerIsAnAlt(player) then
                            ruleConfirmedCheck = true; table.insert(tempRuleCollection, { "Main/Alt", GRM.L("Player is an Alt") });
                    ...
                    if ruleConfirmedCheck and rule.activityFilter and not (rule.rankFilter and rule.applyEvenIfActiive) then
                        ...
                        if not rule.allAltsApplyToKick or (rule.allAltsApplyToKick and not GRM.IsAnyAltActiveForRecommendKicks(GRM.GetAltNamesList(player), ruleName)) then
                            if player.lastOnline >= GRM_G.NumberOfHoursTilRecommend.kick[ruleName] then
                                ruleConfirmedCheck = true; table.insert(tempRuleCollection, { "Inactive", player.lastOnline });
                            end
                        end
                    end
                    -- Rank Filters (when not applying if active)
                    ...
                    -- Extra activity filter based on rank (when applying even if active)
                    if ruleConfirmedCheck and not rule.activityFilter and rule.rankFilter and rule.applyEvenIfActiive then
                        ruleConfirmedCheck = false;
                        player = GRM.Time.ValidateHist(player);
                        if player.rankHist and player.rankHist[1] then
                    ...
                    if ruleConfirmedCheck and GRM_G.BuildVersion >= 40000 and rule.repFilter then
                        ...
                        if #msg > 0 then
                            ruleConfirmedCheck = true; table.insert(tempRuleCollection, { "Rep", GRM.L("Rep: {name} - {name2}", GRM.GetReputationTextLevel(player.guildRep, true), msg) });
                        end
                    end
                    -- Mythic+ filter
                    if ruleConfirmedCheck and GRM_G.BuildVersion >= 80000 and rule.mythicPlusFilter then
                        ...
                        if #msg > 0 then
                            ruleConfirmedCheck = true; table.insert(tempRuleCollection, { "Mythic", GRM.L("Mythic+ Rating: {num}", nil, nil, rule.mythicRating) });
                        end
                    end
                    -- Note match filter
                    if ruleConfirmedCheck and rule.noteMatch and not rule.noteMatchEmpty then
                        if #rule.matchingString > 0 then
                            ruleConfirmedCheck = false;
                            if rule.notesToCheck[1] and string.find(string.lower(player.note or ""), string.lower(rule.matchingString), 1, true) then
                                ruleConfirmedCheck = true;
                            end
                            if not ruleConfirmedCheck and rule.notesToCheck[2] and string.find(string.lower(player.officerNote or ""), string.lower(rule.matchingString), 1, true) then
                                ruleConfirmedCheck = true;
                            end
                            if not ruleConfirmedCheck and rule.notesToCheck[3] and player.customNote and string.find(string.lower(player.customNote[4] or ""), string.lower(rule.matchingString), 1, true) then
                                ruleConfirmedCheck = true;
                            end
                    ...
                    if ruleConfirmedCheck and rule.noteMatch and rule.noteMatchEmpty then
                        ruleConfirmedCheck = false; local notes = "";
                        if rule.notesToCheck[1] and (player.note or "") == "" then
                            notes = GRM.L("Public");
                        end
                        if rule.notesToCheck[2] and (player.officerNote or "") == "" then
                            notes = notes .. (#notes > 0 and " , " or "") .. GRM.L("Officer");
                        end
                        if rule.notesToCheck[3] and player.customNote and (player.customNote[4] or "") == "" then
                            notes = notes .. (#notes > 0 and " , " or "") .. GRM.L("Custom");
                        end
                        if #notes > 0 then
                            ruleConfirmedCheck = true; table.insert(tempRuleCollection, { "Empty Note Match", notes });
                        end
                    end
                    -- Safe Note
                    if ruleConfirmedCheck and rule.safeMatch then
                        local safeTextFound = false;
                        if player.officerNote and player.officerNote ~= "" and string.find(player.officerNote, rule.safeText, 1, true) then
                            safeTextFound = true;
                        end
                        if not safeTextFound and rule.safeMatchAllNotes then
                            if player.note and player.note ~= "" and string.find(player.note, rule.safeText, 1, true) then
                                safeTextFound = true;
                            end
                            if not safeTextFound and player.customNote and player.customNote[4] and player.customNote[4] ~= "" and string.find(player.customNote[4], rule.safeText, 1, true) then
                                safeTextFound = true;
                            end
                        end
                        if safeTextFound then
                            ruleConfirmedCheck = false;
                        else
                        ...
                        if rule.isEnabled then
                            if not player.safeList or not player.safeList.kick or not player.safeList.kick[1] then
                                if not isActionForHigherAltOnly then
                                    ...
                                    higherAltRuleMatchesCount = higherAltRuleMatchesCount + 1;
                                end
                            end
                        else -- rule.isEnabled is false
                            ruleDisabledListForThisChunk[player.name] = true;
                        end
                    end
                end
...
GRM.GetPromoteAndDemoteNamesByFilterRulesChunk = function(ruleTypeIndex, allPlayerNamesSorted, startIndex, chunkSize, includeHigherAlt, highest)
    ...
    local ruleDisabledListForThisChunk = {};
    local higherAltRuleMatchesCount = 0;
    ...
    GRM_G.countAction[ruleTypeIndex] = time();

    if GRM.GetRulesCount(ruleTypeIndex) == 0 or not GRM_G.guildName or GRM_G.guildName == "" then
        return recommendationsForThisChunk, higherAltRuleMatchesCount, ruleDisabledListForThisChunk;
    end
    ...
    local function GetOrAddPlayerRecEntry(list, playerName, playerClass, playerLastOnline, actionType, macroCmd, destRankIndex, mainName , customMsg )
        ...
        local newEntry = {
            ...
            action = actionType, -- "Promote" or "Demote"
            macro = macroCmd,
    ...
    for i = startIndex, endIndex do
        ...
        if processThisPlayer then
            local playerRecommendationEntry = nil; -- For the current player, if they match any rule

            for ruleName, rule in pairs(GRM.S()[GRM_UI.ruleTypeEnum[ruleTypeIndex]]) do
                local processThisRuleForPlayer = true;
                ruleConfirmedCheck = true;
                tempRuleCollection = {};
                local isActionForHigherAltOnly = false;
                ...
                if ruleTypeIndex == 2 and CanGuildPromote() and GRM_G.playerRankID < player.rankIndex then
                    canCurrentCharacterAct = true;
                elseif ruleTypeIndex == 3 and CanGuildDemote() and GRM_G.playerRankID < player.rankIndex then
                    canCurrentCharacterAct = true;
                end

                local canHigherAltAct = false;
                if includeHigherAlt and highest and highest[1] and GRM_G.playerRankID ~= highest[1] and highest[1] < player.rankIndex then
                    -- Check if higher alt has specific perm for this ruleType
                    local higherAltCanPromote, higherAltCanDemote = GRM.GetPlayerRankPermissions(nil, highest[1]);
                    if ruleTypeIndex == 2 and higherAltCanPromote then
                        canHigherAltAct = true;
                    elseif ruleTypeIndex == 3 and higherAltCanDemote then
                        canHigherAltAct = true;
                    end
                end

                if canCurrentCharacterAct then
                    isActionForHigherAltOnly = false;
                elseif canHigherAltAct then
                    isActionForHigherAltOnly = true;
                else
                    if not rule.isEnabled then
                        ruleDisabledListForThisChunk[player.name] = true;
                    end
                    processThisRuleForPlayer = false; -- Skip this rule
                end
                ...
                if processThisRuleForPlayer then
                    ...
                    if not canMove then
                        ...
                        -- Initial rule entry for destination rank
                        table.insert(tempRuleCollection, { rankDestinationText[rule.ruleType], GuildControlGetRankName(rule.destinationRank), numRankMoves });
                    end
                end
                ...
                if processThisRuleForPlayer then
                    ...
                    if ruleConfirmedCheck and rule.applyRulesTo > 1 then
                        ...
                        if rule.applyRulesTo == 2 and not GRM.IsMain(player.name) and GRM.PlayerIsAnAlt(player) then
                            ruleConfirmedCheck = true; table.insert(tempRuleCollection, { "Main/Alt", GRM.L("Player is an Alt") });
                        elseif rule.applyRulesTo == 3 and GRM.IsMain(player.name) then
                            ruleConfirmedCheck = true; table.insert(tempRuleCollection, { "Main/Alt", GRM.L("Player is a Main") });
                        end
                    end

                    -- ACTIVITY (DemoteFilterMatch / PromoteFilterMatch)
                    if ruleConfirmedCheck and rule.activityFilter then
                        if rule.ruleType == 3 then -- Demotion
                            ruleConfirmedCheck, tempRuleCollection = DemoteFilterMatch(player, ruleName, rule, tempRuleCollection);
                        elseif rule.ruleType == 2 then -- Promotion
                            ruleConfirmedCheck, tempRuleCollection = PromoteFilterMatch(player, ruleName, rule, tempRuleCollection);
                        end
                    end

                    -- RANK FILTER (not activity based on rank, but general rank filter)
                    ...
                    if ruleConfirmedCheck then
                        if rule.isEnabled then
                            local safeListKey = GRM_UI.ruleTypeEnum2[rule.ruleType]; -- "promote" or "demote"
                            if not player.safeList or not player.safeList[safeListKey] or not player.safeList[safeListKey][1] then
                                local playerMatchesOnlineStatus = false;
                                if rule.ruleType == 2 then -- Promote
                                    if (not GRM.S().promoteOnlineOnly) or (GRM.S().promoteOnlineOnly and GRM.G_Util.IsGuildieOnline(player.name, player)) then
                                        playerMatchesOnlineStatus = true;
                                    end
                                elseif rule.ruleType == 3 then -- Demote
                                     if (not GRM.S().demoteOnlineOnly) or (GRM.S().demoteOnlineOnly and GRM.G_Util.IsGuildieOnline(player.name, player)) then
                                        playerMatchesOnlineStatus = true;
                                    end
                                end
                                -- Note: Kick (rule.ruleType == 1) is not handled by this function.

                                if playerMatchesOnlineStatus then
                                    if not isActionForHigherAltOnly then
                                        if not playerRecommendationEntry then
...
GRM_UI.GetNamesBySpecialRulesChunk = function(allPlayerNamesSorted, startIndex, chunkSize, includeHigherAlt, highest)
    ...
    if GRM.GetRulesCount(4) == 0 or not GRM_G.guildName or GRM_G.guildName == "" then
        return recommendationsForThisChunk, higherAltRuleMatchesCount, ruleDisabledListForThisChunk;
    end

    local function CreateRecommendationEntry(playerObj, rule, tempRuleCollectionDetails, actionType, destRank, numJumpsVal)
        local entry = {
            name = playerObj.name,
            class = GRM.GetClassColorRGB(playerObj.class),
            lastOnline = playerObj.lastOnline,
            action = GRM_UI.ruleTypeEnum3[actionType],
            macro = (actionType == 2 and "/gpromote" or "/gdemote"),
            rankIndex = destRank,
            mainName = GRM.GetFormattedMainName(playerObj, true),
            numRankJumps = numJumpsVal,
        };
        table.insert(entry, { rule.name, tempRuleCollectionDetails });
        return entry;
    end

    local tempRuleCollection;
    local ruleConfirmedCheck; -- This flag seems to be used per-rule to chain conditions
    local altGroups = GRM_Macro.GetFullDatabaseAltsWithMain();

    local function GetPlayerAltGroupInfo(playerName)
        for _, group in pairs(altGroups) do
            if group[playerName] then
                return group, group.rankIndex;
            end
        end
        return nil, nil;
    end
    ...
    for i = startIndex, endIndex do
        local currentIterationPlayerName = allPlayerNamesSorted[i];
        local player = GRM.GetPlayer(currentIterationPlayerName);
        local processThisPlayerOuter = true;
        local playerHasMatchedSpecialRule = false;

        if not player or type(player) ~= "table" then
            processThisPlayerOuter = false;
        end

        if processThisPlayerOuter then
            local playerAltGroup, mainRankInd = GetPlayerAltGroupInfo(player.name);
            if not playerAltGroup then
                processThisPlayerOuter = false;
            end

            if processThisPlayerOuter and player.name == GRM_G.addonUser then
                 if not (includeHigherAlt and highest and highest[2] and highest[2] ~= player.name) then
                    processThisPlayerOuter = false;
                end
            end
            ...
            if processThisPlayerOuter then
                for ruleName, rule in pairs(GRM.S().specialRules) do
                    if playerHasMatchedSpecialRule then -- If a rule already matched for this player, skip other rules
                        break;
                    end

                    local processThisRuleForPlayer = true; -- Flag for current rule processing
                    ruleConfirmedCheck = true; -- Reset for each rule
                    tempRuleCollection = {};
                    local isActionForHigherAltOnly = false;
                    ...
                    if not ((not rule.syncToMain or (rule.syncToMain and mainRankInd ~= 0)) and (rule.allRanks or (not rule.allRanks and rule.ranks[(GuildControlGetNumRanks() - mainRankInd)]))) then
                        processThisRuleForPlayer = false;
                    end

                    if processThisRuleForPlayer then
                        local canCurrentCharAct = (GRM_G.playerRankID < player.rankIndex and CanGuildPromote() and CanGuildDemote());
                        local canHigherAltAct = false;
                        if includeHigherAlt and highest and highest[1] and GRM_G.playerRankID ~= highest[1] and highest[1] < player.rankIndex then
                             local higherAltCanPromote, higherAltCanDemote = GRM.GetPlayerRankPermissions(nil, highest[1]);
                             if higherAltCanPromote and higherAltCanDemote then
                                canHigherAltAct = true;
                             end
                        end

                        if canCurrentCharAct then isActionForHigherAltOnly = false;
                        elseif canHigherAltAct then isActionForHigherAltOnly = true;
                        else
                            if not rule.isEnabled then ruleDisabledListForThisChunk[player.name] = true; end
                            processThisRuleForPlayer = false;
                        end
                    end

                    if processThisRuleForPlayer then
                        if rule.syncToMain then destinationRank = mainRankInd;
                        else destinationRank = rule.destinationRank - 1; end

                        local effectiveUserRankForComparison = GRM_G.playerRankID;
                        if isActionForHigherAltOnly and highest and highest[1] then
                            effectiveUserRankForComparison = highest[1];
                        end

                        if not (destinationRank ~= player.rankIndex and
                                destinationRank > effectiveUserRankForComparison and
                                (not rule.disableDemote or (rule.disableDemote and destinationRank < player.rankIndex))) then
                            processThisRuleForPlayer = false;
                        end

                        if processThisRuleForPlayer then
                            if destinationRank < player.rankIndex then actionType = 2; else actionType = 3; end

                            local canBeMoved, numJumpsCalc = GRM_UI.PlayerCanBeMoved(player.rankIndex, destinationRank, actionType, isActionForHigherAltOnly, highest);
                            if not canBeMoved then processThisRuleForPlayer = false;
                            else
                                numJumps = numJumpsCalc;
                                if rule.syncToMain then
                                ...
                                table.insert(tempRuleCollection, { "Destination", GRM.L("Destination Rank: {name}", GuildControlGetRankName(destinationRank + 1)) .. " " .. GRM_Macro.GetJumpsMsg(numJumps, actionType) });
                            end
                        end
                    end
                    ...
                    if processThisRuleForPlayer then
                        ...
                        if not ruleConfirmedCheck then -- ruleConfirmedCheck is used as a chain, if any sub-filter sets it to false.
                             processThisRuleForPlayer = false;
                        end
                    end
                    ...
                    if processThisRuleForPlayer then
                        if rule.isEnabled then
                            if not isActionForHigherAltOnly then
                                local recEntry = CreateRecommendationEntry(player, rule, tempRuleCollection, actionType, destinationRank, numJumps);
                                table.insert(recommendationsForThisChunk, recEntry);
                                playerHasMatchedSpecialRule = true; -- Set flag to break from rule loop for THIS player
                            else
                                higherAltRuleMatchesCount = higherAltRuleMatchesCount + 1;
                            end
                        else
        ...
        for _ , player in pairs ( guildData ) do
            if type ( player ) == "table" and player.safeList[rule][1] and player.name ~= GRM_G.addonUser then
                ...
                if getCountAndPlayers then
                    ...
                    names[count].lastOnlineTime = player.lastOnlineTime;
                end
            end
        end
    return count , names;
...
GRM.GetCountOfNamesBeingFilteredScan = function(callbackOnComplete)
    ...
    local currentCanRemove = CanGuildRemove();
    local effectiveCanPromote = currentCanPromote; -- Permissions considering higher alt
    local effectiveCanDemote = currentCanDemote;
    local effectiveCanRemove = currentCanRemove;
    local includeHigherAlt = false;
    ...
    if highest and highest[1] and highest[1] ~= GRM_G.playerRankID then -- Check if highest exists and is different
        local altPermsPromote, altPermsDemote, altPermsRemove = GRM.GetPlayerRankPermissions(nil, highest[1]);
        if altPermsPromote and not effectiveCanPromote then
            effectiveCanPromote = true;
        end
        if altPermsDemote and not effectiveCanDemote then
            effectiveCanDemote = true;
        end
        if altPermsRemove and not effectiveCanRemove then
    ...
    GRM_G.countingScanState = {
        ...
        allNames = allGuildPlayerNamesSorted,
        chunkSize = 100, -- larger for counting since not processing all players
        currentIndex = 1,

        highest = highest,
        includeHigherAlt = includeHigherAlt,
        effectiveCanPromote = effectiveCanPromote,
        effectiveCanDemote = effectiveCanDemote,
        effectiveCanRemove = effectiveCanRemove,

        -- Accumulated counts
        k = 0, p = 0, d = 0, s = 0, -- Current character counts
        k2 = 0, p2 = 0, d2 = 0, s2 = 0, -- Higher alt counts

        currentCategory = "KICK", -- KICK, PROMOTION, DEMOTION, SPECIAL, DONE
    };

    -- Start the first processing cycle for counts
...
GRM.ProcessNextCountingChunk = function()
    ...
    -- Determine if we need to process this category based on effective permissions
    local shouldProcessCategory = false;
    if state.currentCategory == "KICK" and state.effectiveCanRemove then
        shouldProcessCategory = true;
    end
    if state.currentCategory == "PROMOTION" and state.effectiveCanPromote then
        shouldProcessCategory = true;
    end
    if state.currentCategory == "DEMOTION" and state.effectiveCanDemote then
        shouldProcessCategory = true;
    end
    if state.currentCategory == "SPECIAL" and state.effectiveCanPromote and state.effectiveCanDemote then
        shouldProcessCategory = true;
    end

    if not shouldProcessCategory then
        -- Skip this category and move to the next one
        if state.currentCategory == "KICK" then
            advanceCategory("PROMOTION");
            return;
        elseif state.currentCategory == "PROMOTION" then
            advanceCategory("DEMOTION");
            return;
        elseif state.currentCategory == "DEMOTION" then
            advanceCategory("SPECIAL");
            return;
        elseif state.currentCategory == "SPECIAL" then
            advanceCategory("DONE");
            return;
        end
    end

    if state.currentIndex > #state.allNames and state.currentCategory ~= "DONE" then
        -- Finished processing all names for the current category, move to next
        if state.currentCategory == "KICK" then
            advanceCategory("PROMOTION");
            return;
        elseif state.currentCategory == "PROMOTION" then
    ...
    if state.currentCategory == "KICK" then
        recommendationsInChunk, higherAltCountForChunk = GRM.GetKickNamesByFilterRulesChunk(
            state.allNames, state.currentIndex, state.chunkSize, state.includeHigherAlt, state.highest
        );
        if recommendationsInChunk then
            state.k = state.k + #recommendationsInChunk;
        end
        if higherAltCountForChunk then
            state.k2 = state.k2 + higherAltCountForChunk;
        end
        GRM_G.counts[1][1] = state.k; -- Update global cache as we go
        GRM_G.counts[1][2] = state.k2;

    elseif state.currentCategory == "PROMOTION" then
        recommendationsInChunk, higherAltCountForChunk = GRM.GetPromoteAndDemoteNamesByFilterRulesChunk(
            2, state.allNames, state.currentIndex, state.chunkSize, state.includeHigherAlt, state.highest
        );
        if recommendationsInChunk then
            state.p = state.p + #recommendationsInChunk;
        end
        if higherAltCountForChunk then
            state.p2 = state.p2 + higherAltCountForChunk;
        end
        GRM_G.counts[2][1] = state.p;
        GRM_G.counts[2][2] = state.p2;
    ...
    elseif state.currentCategory == "DEMOTION" then
        ...
        if recommendationsInChunk then
            state.d = state.d + #recommendationsInChunk;
        end
        if higherAltCountForChunk then
            state.d2 = state.d2 + higherAltCountForChunk;
        end
        GRM_G.counts[3][1] = state.d;
        GRM_G.counts[3][2] = state.d2;

    elseif state.currentCategory == "SPECIAL" then
        recommendationsInChunk, higherAltCountForChunk = GRM_UI.GetNamesBySpecialRulesChunk(
            state.allNames, state.currentIndex, state.chunkSize, state.includeHigherAlt, state.highest
        );
        if recommendationsInChunk then
            state.s = state.s + #recommendationsInChunk;
        end
        if higherAltCountForChunk then
            state.s2 = state.s2 + higherAltCountForChunk;
        end
        GRM_G.counts[4][1] = state.s;
...
-- What it Does:    Returns the most recently calculated/cached counts.
-- Purpose:         For immediate UI needs if async update is too slow or not required.
GRM.GetCachedRuleCounts = function()
    -- Ensure GRM_G.counts is initialized if it hasn't been
    GRM_G.counts = GRM_G.counts or { [1]={}, [2]={}, [3]={}, [4]={} }
    GRM_G.counts[1] = GRM_G.counts[1] or {0,0}
    GRM_G.counts[2] = GRM_G.counts[2] or {0,0}
    GRM_G.counts[3] = GRM_G.counts[3] or {0,0}
    GRM_G.counts[4] = GRM_G.counts[4] or {0,0}

    local k = GRM_G.counts[1][1] or 0;
    local k2 = GRM_G.counts[1][2] or 0;
    local p = GRM_G.counts[2][1] or 0;
    local p2 = GRM_G.counts[2][2] or 0;
    local d = GRM_G.counts[3][1] or 0;
    local d2 = GRM_G.counts[3][2] or 0;
    local s = GRM_G.counts[4][1] or 0;
    local s2 = GRM_G.counts[4][2] or 0;

    -- as this function returns cached counts, not a list from a specific category.
    return k, p, d, s, nil, k2, p2, d2, s2;
end
...
GRM_UI.UpdateToolButtonText = function(k_val, p_val, d_val, s_val, k2_val, p2_val, d2_val, s2_val)
    -- Store these counts if other UI parts need them directly from GRM_UI context
    GRM_UI.GRM_LoadToolButton.count = {k_val, p_val, d_val, s_val, nil, k2_val, p2_val, d2_val, s2_val};

    local total = (k_val or 0) + (p_val or 0) + (d_val or 0) + (s_val or 0) +
                  (k2_val or 0) + (p2_val or 0) + (d2_val or 0) + (s2_val or 0);

    GRM_UI.GRM_LoadToolButton.total = total;

    -- Only update text if the button is visible and the total has changed
    if GRM_UI.GRM_LoadToolButton:IsVisible() and GRM_UI.GRM_LoadToolButton.lastTotalCount ~= total then
        if total > 0 then
            GRM_UI.GRM_LoadToolButtonText:SetText(GRM.L("Macro Tool: {num}", nil, nil, total));
        else
...
GRM_UI.RefreshToolButtonsOnUpdate_Async = function(forced , refreshMacroToolText )
    ...
    elseif not forced then
        -- Guild name not yet available, set default text and retry
        if GRM_UI.GRM_LoadToolButton:IsVisible() and GRM_UI.GRM_LoadToolButton.lastTotalCount ~= 0 then
             GRM_UI.GRM_LoadToolButtonText:SetText(GRM.L("Macro Tool"));
             GRM_UI.GRM_LoadToolButton.lastTotalCount = 0;
        end
        C_Timer.After(30, function()
            GRM_UI.RefreshToolButtonsOnUpdate_Async(false); -- Pass false to respect throttling
        end);
    end
end
...
--     -- DO NOT SEND FOR NOW
--     -- GRMsync.SendMessage ( "GRM_SYNC" , prefix .. "?" .. msg , GRMsyncGlobals.channelName );
-- end
...
--     GRMsync.SendMessage ( "GRM_SYNC" , "GRM_MACRO_T?" .. tostring (GRMsyncGlobals.timeAtLogin) , GRMsyncGlobals.channelName );
-- end
